...
scripts = [
    ...
    # # gsm8khard
    "\"python run_gsm8k.py --model_type vllm --model_ckpt ../Llama-2-7b-hf --data_split test_all --task gsm8khard\"",
    "\"python run_gsm8k.py --model_type vllm --model_ckpt ../Meta-Llama-3-8B-Instruct --data_split test_all --task gsm8khard\"",
